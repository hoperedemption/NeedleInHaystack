...
/**
 * @brief check whether the string is valid or not
 *
 * @param str a string to check whether it is valid or not
 * @param max_length the maximum allowable length of the string
 * @return whether the string is valid, i.e not empty and not of length greater than max_length
 */
int check_if_string_is_valid(char* str, int max_length);
